...
export default function Footer({setEmail}) {

  const handleInputChange = (e) => {
    setEmail(e.target.value);
  };
  return (
    <div id="footer" className="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
        ...
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <div className="footer-item">
              ...
              {/*  Ассортимент*/}
              {/*</a>*/}
              <Button href="#shop" lg className="m-lg-4  rounded-5 border-warning " style={{backgroundColor:"#32CD32", whiteSpace: "nowrap"}}>Ассортимент</Button>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
